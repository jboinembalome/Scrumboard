...
export const APIS = [AdherentsService, BoardsService, CardsService, CommentsService, LabelsService, OidcConfigurationService, TeamsService, WeatherForecastService];
