...
export class ScrumboardCardDialogComponent implements OnInit, OnDestroy
{
    ...
    addNewComment(form: NgForm): void
    {
        ...
        this.translate.get('SCRUMBOARD.NOW')
        .subscribe(val => now = val);
    ...
    removeCard(): void
    {
        ...
        this.translate.get('SCRUMBOARD.CONFIRM_DELETE_CARD')
        .subscribe(val => this.confirmDialogRef.componentInstance.confirmMessage = val);
