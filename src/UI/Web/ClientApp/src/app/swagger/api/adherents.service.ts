...
export class AdherentsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiAdherentsTeamsTeamIdGet(teamId: number, observe?: 'body', reportProgress?: boolean): Observable<Array<LabelDto>>;
    public apiAdherentsTeamsTeamIdGet(teamId: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<LabelDto>>>;
    public apiAdherentsTeamsTeamIdGet(teamId: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<LabelDto>>>;
    public apiAdherentsTeamsTeamIdGet(teamId: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<LabelDto>>('get',`${this.basePath}/api/Adherents/teams/${encodeURIComponent(String(teamId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
