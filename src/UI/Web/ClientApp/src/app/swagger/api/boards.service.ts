 ...
 *//* tslint:disable:no-unused-variable member-ordering */
 ...
 export class BoardsService {
      ...
      * @param reportProgress flag to report request and response progress.
      */
     public apiBoardsIdLabelsGet(id: number, observe?: 'body', reportProgress?: boolean): Observable<Array<LabelDto>>;
     public apiBoardsIdLabelsGet(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<LabelDto>>>;
     public apiBoardsIdLabelsGet(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<LabelDto>>>;
     public apiBoardsIdLabelsGet(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
 
         if (id === null || id === undefined) {
             throw new Error('Required parameter id was null or undefined when calling apiBoardsIdLabelsGet.');
         }
